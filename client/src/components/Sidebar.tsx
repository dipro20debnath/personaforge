...
import { LayoutDashboard, User, Brain, TrendingUp, Target, CheckSquare, BookOpen, PenLine, FileText, Map, Heart, Shield, Moon, Sun, LogOut, Bell, Menu, X, Sparkles, Clock, Flame, Wallet, Mic, Globe } from 'lucide-react';
